 ...
 * @LastEditors: Peter
 * @LastEditTime: 2026-06-04 17:31:38
 * @FilePath: /NavHub/templates/header-banner.php
 * @Description: 
 */
    ...
    <div class="navbar-content">
      ...
      <ul class="user-info-menu list-inline list-unstyled">
        <li class="hidden-sm hidden-xs">
            <a href="https://github.com/zhangchunsheng/NavHub" target="_blank"><i class="fa fa-github"></i> GitHub</a>
        </li>
      </ul>
    </div>
</nav>