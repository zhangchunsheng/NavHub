 ...
 * @LastEditors: Peter
 * @LastEditTime: 2026-06-04 23:21:25
 * @FilePath: /NavHub/inc/frame/config/framework.config.php
 * @Description: 
 */
...
$settings           = array(
  ...
  'framework_title' => 'NavHub '.__('主题设置','io_setting').'<style>.cs-framework .cs-body {min-height: 700px;}</style><span style="font-size: 14px;"> - V '.wp_get_theme()->get('Version').'</span>',
...
$options[] = array(
    ...
    'fields' => array(
        array(
            'type'    => 'notice',
            'content' => '---》<a href="https://www.luomor.com/wordpress-version-navhub/" target="_blank">查看教程</a>《---',
            'class'   => 'info',
        ),
        array(
            'type'    => 'notice',
            'content' => '---》<a href="https://nav.luomor.com" target="_blank">帮助中心</a>《---',
            'class'   => 'info',
        ),
        array(
            'id' => 'logo_normal',
        ...
        array(
            ...
            'title' => '登录页背景图',
            'add_title' => '上传',
            'default'   => get_theme_file_uri('/images/login.png'),
...
$options[] = array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'desc'    => 'api 地址',
            'after'   => '默认api地址：https://t3.gstatic.cn/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&size=128&url=<br>如果获取图标失效，请百度搜索‘获取网站图标api’替换能用的就可以了<br>或者自建api服务，源码地址：<a href="https://www.luomor.com/favicon-api/" target="_blank">https://www.luomor.com/favicon-api/</a>',
        ),
        array(
            'id'      => 'url_format',
            'type'    => 'switcher',
...
$options[] = array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'       => 'wysiwyg',
            'title'      => '首页顶部广告位内容',
            'default'    => '<a href="https://www.luomor.com/wordpress-version-navhub/" target="_blank"><img src="' . get_template_directory_uri() . '/screenshot.png" alt="广告也精彩" /></a>',
            'settings'   => array(
              'textarea_rows' => 5,
              'tinymce'       => false,
              'media_buttons' => false,
...
$options[] = array(
	...
	'icon'  => 'fa fa-qrcode',
  	...
  	'fields' => array(
  		...
  		array(
			'type'    => 'subheading',
			'content' => '嘿！你好，欢迎使用NavHub主题。<br><br>目前这款主题为免费公开，如使用过程中遇到什么问题，可到博客<a href="https://www.luomor.com" target="_blank">烙馍网</a>反馈<br><br>制作一款WordPress主题不易，欢迎各位老板伸出援手，友情赞助！（你们的支持就是我最大的动力！）',
		),
		...
		array(
		    ...
		    'options' => array(
				...
				'alipay' => get_stylesheet_directory_uri() . '/images/alipay_qrcode.jpg',
		    ),
		),
	),
);
