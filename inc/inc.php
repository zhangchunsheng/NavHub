 ...
 * @LastEditors: Peter
 * @LastEditTime: 2026-06-04 23:22:56
 * @FilePath: /NavHub/inc/inc.php
 * @Description: 
 */
...
function left_admin_footer_text($text) {
    $text = '<span id="footer-thankyou">感谢您使用 <a href="https://nav.luomor.com/" target="_blank">烙馍网的 WordPress 主题</a></span>';
    return $text;
}
...
/**
 * 美化Wordpress登录页 By 烙馍网
 * 原文地址：https://www.luomor.com/chundaimameihuawordpressmorendengluye/
 */
...
function io_login_footer(){
    ...
    <div class="footer-copyright position-absolute">
            <span>Copyright © <a href="'. esc_url(home_url()) .'" class="text-white-50" title="'. get_bloginfo('name') .'" rel="home">'. get_bloginfo('name') .'</a>&nbsp;&nbsp;Modify by <a href="https://nav.luomor.com" target="_blank">烙馍网</a></span> 
    </div>';
}
...
function custom_login_style(){
    ...
    .img-bg{color:#fff;padding:2rem;bottom:-2rem;left:0;top:-2rem;right:0;border-radius:10px;background-image:url('.io_get_option('login_img',get_theme_file_uri('/images/login.png')).');background-repeat:no-repeat;background-position:center center;background-size:cover}
